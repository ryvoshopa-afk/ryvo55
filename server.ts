...
import {
  ...
  LocalDocSnapshotWrapper,
  LocalDocRefWrapper,
  LocalCollectionRefWrapper,
  LocalDbAdapter,
  ClientDocSnapshotWrapper,
  ClientDocRefWrapper,
  ClientCollectionRefWrapper,
  ClientDbAdapter,
  doc,
  collection,
  getDoc,
...
} from "./server/services/firestoreLayer";
...
app.post("/api/support/conversations/:id/message", async (req, res) => {
  ...
  try {
    ...
    } else if (sender === 'support' || sender === 'agent') {
